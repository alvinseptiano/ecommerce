<template>
  <div class="flex flex-wrap gap-1">
    <Sortable :list="imageUrls" item-key="id" class="flex gap-1 flex-wrap" @end="onImageDragEnd">
    ...
    <div
      ...
      <input type="file" class="absolute left-0 top-0 bottom-0 right-0 w-full h-full opacity-0" @change="onFileChange"
        multiple>
    </div>
  </div>
</template>
