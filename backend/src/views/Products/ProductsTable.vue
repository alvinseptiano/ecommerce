<template>
	<div class="bg-primary p-4 rounded-lg shadow animate-fade-in-down">
							...
							<transition enter-active-class="transition duration-100 ease-out"
								...
								<MenuItems
									...
									<div class="px-1 py-1">
										...
										<router-link :to="{ name: 'app.products.edit', params: { id: product.id } }"
											:class="[
		...
		<div v-if="!products.loading" class="flex justify-between items-center mt-5">
			...
			<nav v-if="products.total > products.limit"
				class="relative z-0 inline-flex justify-center rounded-md shadow-sm -space-x-px m-auto"
